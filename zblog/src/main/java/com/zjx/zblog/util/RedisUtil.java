...
public class RedisUtil {
     ...
     *
     * @param key   有序集合的键
     * @param tuples 要添加的元素集合，每个元素包含值和分数
     * @return 添加成功的元素数量
     */
    public long batchZSet(String key, Set<ZSetOperations.TypedTuple> tuples) {
    ...
    /**
     * 对多个有序集合进行并集操作，并将结果存储到新的有序集合中.
     *
     * @param key      主有序集合的键
     * @param otherKeys 其他参与并集操作的有序集合的键集合
     * @param destKey  存储并集结果的有序集合的键
     */
